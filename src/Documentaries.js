...
const docu="https://api.themoviedb.org/3/discover/movie?api_key=80c95bc22926c4f745ce1f6f392fbb14&with_genres=99";
...
function Documentaries(){
    ...
    React.useEffect(function()               // Logic to fetch all the movies info
    {
        ...
        {
             const output=await Axios.get(docu)     //React app visits TMDB, which takes some time, to give movie info to output variables
