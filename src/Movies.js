...
const netflixOriginals="https://api.themoviedb.org/3/discover/tv/?api_key=80c95bc22926c4f745ce1f6f392fbb14&with_network=123";
...
function Movies(){
    ...
    React.useEffect(function()               // Logic to fetch all the movies info
    {
        ...
        {
             const output=await Axios.get(netflixOriginals)     //React app visits TMDB, which takes some time, to give movie info to output variables
